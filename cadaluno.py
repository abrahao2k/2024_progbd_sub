...
class Ui_CadAluno(object):
    def setupUi(self, CadAluno):
        ...
        self.label_observacao = QtWidgets.QLabel(parent=self.centralwidget)
        self.label_observacao.setObjectName("label_observacao")
        self.formLayout.setWidget(4, QtWidgets.QFormLayout.ItemRole.LabelRole, self.label_observacao)
        ...
        self.horizontalLayout_turno.addWidget(self.radioButton_manha)
        ...
        self.horizontalLayout_turno.addWidget(self.radioButton_tarde)
        ...
        self.horizontalLayout_turno.addWidget(self.radioButton_noite)
        ...
        self.horizontalLayout_extra.addWidget(self.checkBox_atleta)
        ...
        self.horizontalLayout_extra.addWidget(self.checkBox_bolsista)
        self.formLayout.setLayout(3, QtWidgets.QFormLayout.ItemRole.FieldRole, self.horizontalLayout_extra)
        self.plainTextEdit_observacao = QtWidgets.QPlainTextEdit(parent=self.centralwidget)
        self.plainTextEdit_observacao.setObjectName("plainTextEdit_observacao")
        self.formLayout.setWidget(4, QtWidgets.QFormLayout.ItemRole.FieldRole, self.plainTextEdit_observacao)
    ...
    def retranslateUi(self, CadAluno):
        ...
        self.label_observacao.setText(_translate("CadAluno", "Observação:"))
    ...
    def salvar(self):
        ...
        #print(nome, curso, turno, atleta, bolsista, observacao)
        
        ## SALVAR NO BANCO ##############################################
        
        cursor.execute(f"""INSERT INTO aluno VALUES(null, '{nome}', '{curso}',
        '{turno}','{atleta}', '{bolsista}', '{observacao}') """)
